#!/usr/bin/env python3
"""Continue gradient-cache experiments from C1 onwards."""
...
results = json.load(open(os.path.join(OUT_ROOT, "results.json"))) if os.path.exists(os.path.join(OUT_ROOT, "results.json")) else {}
N = len(EXPERIMENTS)
